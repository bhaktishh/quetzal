...
;; @generated by Idris 0.7.0-6c6ee58eb, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define Main-login (lambda (arg-0 ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "enter password: " ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_String act-2 "password123"))) (cond ((equal? sc0 1) (cons 0 arg-0)) (else (cons 1 arg-0))))))))
(define Main-logout (lambda (arg-0 ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "logging out\xa;" ext-0))) (cons 'erased arg-0))))
(define Main-readSecret (lambda (arg-0 ext-0) (cons (let ((e-0 (car arg-0))) e-0) arg-0)))
(define PreludeC-45IO-u--map_Functor_IO (lambda (arg-2 arg-3 ext-0) (let ((act-2 (arg-3 ext-0))) (arg-2 act-2))))
(define Main-run (lambda (arg-3 arg-4 ext-0) (case (vector-ref arg-4 0) ((0) (Main-login arg-3 ext-0)) ((1) (Main-logout arg-3 ext-0)) ((2) (Main-readSecret arg-3 ext-0)) ((3) (let ((e-2 (vector-ref arg-4 1))) (cons e-2 arg-3))) ((4) (let ((e-5 (vector-ref arg-4 1))) (let ((act-5 (PreludeC-45IO-u--map_Functor_IO (lambda (__leftTupleSection-0) (lambda (__infixTupleSection-0) (cons __leftTupleSection-0 __infixTupleSection-0))) e-5 ext-0))) (act-5 arg-3)))) (else (let ((e-11 (vector-ref arg-4 1))) (let ((e-12 (vector-ref arg-4 2))) (let ((act-1 (Main-run arg-3 e-11 ext-0))) (let ((e-2 (car act-1))) (let ((e-3 (cdr act-1))) (Main-run e-3 (e-12 e-2) ext-0))))))))))
(define Main-initStore (cons "secret data :O\xa;" "public data\xa;"))
(define Main-main (vector 5 (vector 0 ) (lambda (u--res) (cond ((equal? u--res 0) (vector 5 (vector 2 ) (lambda (u--secret) (vector 5 (vector 4 (lambda (eta-0) (PreludeC-45IO-prim__putStr u--secret eta-0))) (lambda (u--_) (vector 1 )))))) (else (vector 5 (vector 4 (lambda (eta-0) (PreludeC-45IO-prim__putStr "bad password" eta-0))) (lambda (u--_) (vector 3 'erased))))))))
(define Main-mainC-39 (let ((u--st Main-initStore)) (lambda (world-0) (let ((act-1 (Main-run u--st Main-main world-0))) 'erased))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO Main-mainC-39)
  (collect 4)
  (blodwen-run-finalisers)
